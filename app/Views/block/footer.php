									...
									<div class="foot-news-last">
										<div class="input-group">
											...
											<div class="input-group-append">
												<button type="button" class="input-group-text b-0 text-light "onclick="subscrib()"><i class="lni lni-arrow-right"></i></button>
											</div>
										</div>
									</div>
									<div class="address mt-3">
			...
			<script>
				function subscrib() {
					...
					if (email != '') {
						...
						$.post(PATH + "/Home/subscribe", _data, function(response) {
