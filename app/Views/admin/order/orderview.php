            ...
            <div class="card-header card-header-divider">
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered text-center mb-0" data-id="orderview" id="table_list_data" data-module="admin/Master" data-filter_data="<?=@$order['id'] ?>">
                        ...
                        <div class="col-lg-6 mt-3" style="float:right;">
                            <table class="table table-bordered table-fw-widget mb-0">
                                <tr>
                                    ...
                                    <th>Total Amount</th>
                                    <td>
                                        <h5 class="sub_total_amt"> <?= @$order['total_payment'] ?> </h5>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 class=""> <?= @$order['total_payment'] ?> </h5>
                                    </td>
                                </tr>
                            </table>
                        </div>
