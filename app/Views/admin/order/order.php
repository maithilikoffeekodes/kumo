...
<div class="page-header">
    ...
    <!-- <div class="btn btn-list">
            <a data-toggle="modal" href="<?//= url('admin/Master/createorder')?>" data-target="#fm_model"
                    data-title="Add order" class="btn waves-effect waves-light btn-primary btn-outline-primary btn-round" style="float: right;"><span class="mdi mdi-plus"></span> Add order</a>
    </div> -->
    <!-- <div class="btn btn-list">
        <a  href="<?//= url('admin/Master/createorder') ?>"  data-title="Add order" class="btn waves-effect waves-light btn-primary btn-outline-primary btn-round" style="float: right; border-radius:5px;"><span class="mdi mdi-plus"></span> Add order</a>
    </div> -->
</div>
<!-- End Page Header -->
<div class="row">
            ...
            <div class="card-header card-header-divider">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-fw-widget" id="table_list_data" data-id="order" data-module="admin/Master" data-filter_data='' style="width:100%">
...
<script type="text/javascript">
    ...
    //                 $.post(PATH + "/" + $("#table_list_data").data('module') + "/Action/Delete", _data, function(data) {
