...
<div class="row">
    <div class="col-lg-12">
        <?php //print_r($slider);exit;
        ?>
        <form action="<?= url('admin/Home/createslider') ?>" class="ajax-form-submit" method="post" enctype="multipart/form-data">

            <div class="form-group">
                <label class="form-label">Slider: <span class="tx-danger">*</span></label>
                <input class="form-control" name="slider" placeholder="Enter Name" required type="text" value="<?= @$slider['slider']; ?>">
                <input value="<?= @$slider['id'] ?>" name="id" type="hidden">
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="link" value="<?= @$slider['link']; ?>" placeholder="Enter Link" type="text" required>
